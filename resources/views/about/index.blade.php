    ...
    <main class="blog">
        <div class="container">
            ...
            <section class="edica-about-vision pt-0">
                <div class="row">
                    <div class="col-md-6 pb-3 pb-md-0 mb-4 mb-md-0 d-flex justify-content-center" data-aos="fade-right" data-aos-delay="200">
                        <img src="{{asset('assets/images/forSeeds/135258.jpg')}}" alt="vision"
                             class="img-fluid max-width-65">
                    </div>
                    <div class="col-md-6 d-flex flex-column justify-content-center">
                        <p class="vision-text" data-aos="fade">Lorem ipsum, or lipsum as it is sometimes known, is
            ...
            <section class="edica-about-goal py-5 mb-5">
                <div class="row flex-row-reverse">
                    <div class="col-md-6 pb-3 pb-md-0 mb-4 mb-md-0 d-flex justify-content-center" data-aos="fade" data-aos-delay="300">
                        <img src="{{asset('assets/images/forSeeds/135258.jpg')}}" alt="vision"
                             class="img-fluid d-flex max-width-65">
                    </div>
            ...
            <section class="featured-posts-section">
                <div class="row">
                    <div class="col-md-6 mb-5 d-flex justify-content-center" data-aos="fade-up">
