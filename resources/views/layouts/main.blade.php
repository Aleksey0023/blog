...
<footer class="edica-footer mt-5">
    <div class="container">
        <div class="row footer-widget-area pb-0 justify-content-center">
            <div class="text-center">
                ...
                <p class="contact-details mb-3">BUIVALENKO ANASTASIYA</p>
                <div class="my-2 mx-2">
                    <a href="https://t.me/buivalenkoanastasiya"><img src="{{asset('assets/images/telegram.png')}}"
                                                                 alt="telegram" class="mr-1"></a>
                    <a href="https://vk.com/club210918350"><img src="{{asset('assets/images/vk.png')}}" alt="vk" class="mr-2"></a>
                    <a href="https://dzen.ru/buivalenkoanastasiya"><img src="{{asset('assets/images/dzen.png')}}" alt="vk" class="mr-2"></a>
