            ...
            <div class="row">
                <div
                    ...
                    <ul class="list pl-0">
                        ...
                        <li class="mark"><b>скучно точно не будет:</b> работа с отрывами из песен и фильмов,
                        ...
                        <li class="mark"><b>комфортная и приятная атмосфера:</b> уверена, что на пути достижения
                            результата не обязательно быть «строгой училкой», ругающей за невыполнение домашних заданий.
